      ...
      <div class="flex mt-10   sm:flex-col xs:flex-col md:flex-row ">
        ...
        <div class="p-8">
          <div class="bg-white  text-2xl">
            ...
            <a
              href="#"
              class="hover:text-gray-300 text-xl font-bold mb-2 border border-white rounded text-white px-10 py-1 bg-orange-500 flex items-center w-60 sm:w-full md:w-auto   "
            >
              <p class="sm:ml-44 ">RESERVE TODAY</p>
            </a>
          </div>
        </div>
      </div>
